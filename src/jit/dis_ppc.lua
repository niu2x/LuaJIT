...
local map_rld = {
    ...
    "rldicRR~HM.",
    "rldimiRR~HM.",
    { shift = 1, mask = 1, [0] = "rldclRR~RM.", "rldcrRR~RM." },
}
...
local map_ext = setmetatable(
    {
        ...
        [598] = { shift = 21, mask = 3, [0] = "sync", "lwsync", "ptesync" },
        [758] = "dcba-RR",
        [854] = "eieio",
        [982] = "icbi-R0R",
        [1014] = "dcbz-R0R",
...
local map_ld = { shift = 0, mask = 3, [0] = "ldRRE", "lduRRE", "lwaRRE" }

local map_std = { shift = 0, mask = 3, [0] = "stdRRE", "stduRRE" }
    ...
    for p in gmatch(pat, ".") do
        ...
        elseif p == "B" then
            ...
            if band(bo, 4) == 0 then
                ...
                name = name
                           .. (band(bo, 1) == band(rshift(op, 15), 1) and "-"
                               or "+")
