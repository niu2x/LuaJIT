...
static void
setpath(lua_State* L, const char* fieldname, const char* envname, const char* def, int noenv)
{
...
static const lua_CFunction package_loaders[] = { lj_cf_package_loader_preload,
