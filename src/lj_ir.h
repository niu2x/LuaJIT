...
#define IRTDEF(_)                                                                                  \
    _(NIL, 4)                                                                                      \
    _(FALSE, 4) _(TRUE, 4) _(LIGHTUD, LJ_64 ? 8 : 4) _(STR, IRTSIZE_PGC) _(P32, 4)                 \
        _(THREAD, IRTSIZE_PGC) _(PROTO, IRTSIZE_PGC) _(FUNC, IRTSIZE_PGC) _(P64, 8)                \
            _(CDATA, IRTSIZE_PGC) _(TAB, IRTSIZE_PGC) _(UDATA, IRTSIZE_PGC) _(FLOAT, 4) _(NUM, 8)  \
                _(I8, 1) _(U8, 1) _(I16, 2) _(U16, 2) _(INT, 4) _(U32, 4) _(I64, 8) _(U64, 8)      \
